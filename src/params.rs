...
pub const FRANKA_ROBOT_MAX_JOINT_JERK: [f64; FRANKA_EMIKA_DOF] = [4000.; FRANKA_EMIKA_DOF];
...
pub const FRANKA_ROBOT_MAX_CARTESIAN_VEL: [f64; 2] = [1.7, 2.5];
pub const FRANKA_ROBOT_MAX_CARTESIAN_ACC: [f64; 2] = [13., 25.];
pub const FRANKA_ROBOT_MAX_CARTESIAN_JERK: [f64; 2] = [6500., 12500.];
