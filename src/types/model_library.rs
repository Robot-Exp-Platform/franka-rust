...
impl ModelLibrary {
    ...
    lib_fn!(fn zero_jacobian_joint2(q: &[f64; 7], zero_jo_for_j2: &mut [f64; 42]) from O_J_J2);
    lib_fn!(fn zero_jacobian_joint3(q: &[f64; 7], zero_jo_for_j3: &mut [f64; 42]) from O_J_J3);
    lib_fn!(fn zero_jacobian_joint4(q: &[f64; 7], zero_jo_for_j4: &mut [f64; 42]) from O_J_J4);
    lib_fn!(fn zero_jacobian_joint5(q: &[f64; 7], zero_jo_for_j5: &mut [f64; 42]) from O_J_J5);
    lib_fn!(fn zero_jacobian_joint6(q: &[f64; 7], zero_jo_for_j6: &mut [f64; 42]) from O_J_J6);
    lib_fn!(fn zero_jacobian_joint7(q: &[f64; 7], zero_jo_for_j7: &mut [f64; 42]) from O_J_J7);
    lib_fn!(fn zero_jacobian_flange(q: &[f64; 7], zero_jo_for_j8: &mut [f64; 42]) from O_J_J8);
    lib_fn!(fn zero_jacobian_ee(q: &[f64; 7], pose_f_to_ee: &[f64; 16], zero_jo_for_j9: &mut [f64; 42]) from O_J_J9);
